...
export default function FiltrosEstadisticas({proporcional}) {

    const navigate = useNavigate()

    const [filtro_menu, setFiltroMenu] = useState('analisis')
        ...
        <div style={{width: '100%', height: 56 / proporcional, background: 'rgb(32, 34, 36)', paddingLeft: 16 / proporcional, paddingRight: 16 / proporcional, paddingTop: 8 / proporcional,
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 40 / proporcional}}>
                <div className='d-flex justify-content-start' style={{width: '80%', height: 40 / proporcional}}>
                    ...
                    <p style={{color: filtro_menu === 'analisis' ? 'rgb(130, 180, 64)' : 'rgb(98, 101, 105)', fontSize: 15 / proporcional, fontWeight: 700, lineHeight: `${40 / proporcional}px`, marginBottom: 0, paddingLeft: 8 / proporcional, 
                            cursor: 'pointer', paddingRight:8 / proporcional}} onClick={() => setFiltroMenu('analisis')}>
                        Estadísticas
                    </p>
                    <p style={{color: filtro_menu === 'covid19' ? 'rgb(130, 180, 64)' : 'rgb(98, 101, 105)', fontSize: 15 / proporcional, fontWeight: 700, lineHeight: `${40 / proporcional}px`, marginBottom: 0, paddingLeft: 8 / proporcional, 
                            cursor: 'pointer', paddingRight:8 / proporcional}} onClick={() => setFiltroMenu('covid19')}>
                        Covid 19
                    </p>
                </div>
